 ...
 <div class="content-wrapper">
				...
				<div class="row">
					<div class="col-md-12" style="padding-left:100px;padding-top:40px;">
                            <h1 class="text-bold content-group-sm" style="color:#00264d;" ><b>WOMENZ CHOICE</b></h1> <br/>
                        </div>
					</div>
                    <div class="row">
         ...
         <div class="card">
		   <div class="card-header" style="color:#660000;">
			  ...
			  <div class="card-block" style="color:#660000;">
                     <image class="orderimg" src="Womenz Wear/<?php echo $image;?>" alt=""/><br/>
					<?php  echo "Price.".$cost."tk</br>"; 
		echo "<a href='addToCartWomenzWear.php?cart_id={$product_id}&review_id={$review_id}'><button class='orderbutton'>View</button></a> "; ?>
                                </div>
                            </div>
                        </div>
	<?php } ?>
