...
include "../open_modal.php";
		...
		add_item('skin_hair','../Cosmetics/Skin and Hair/');
	}
}
if(isset($_GET['delete'])){
	delete_product('skin_hair','skin_hair');
}
...
if(isset($_GET['edit'])){
	...
	edit('skin_hair','../Cosmetics/Skin and Hair/');
...
<div class="content">
 ...
 while($row = mysqli_fetch_assoc($select_item)){
		...
		echo "<td><image class='adminimg' src='../Cosmetics/Skin and Hair/{$product_image}' /></td>";
        echo "<td><a href='skin_hair.php?delete={$product_id}'>DELETE</a></td>";
        echo "<td><a href='skin_hair.php?edit={$product_id}'>EDIT</a></td>";		
		echo "</tr>";
    } 
