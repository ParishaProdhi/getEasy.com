...
include "../open_modal.php";
		...
		add_item('make_up','../Cosmetics/Makeup/');
	}
}
if(isset($_GET['delete'])){
	delete_product('make_up','make_up');
}
...
<div class="content">
 ...
 while($row = mysqli_fetch_assoc($select_item)){
		...
		echo "<td><image class='adminimg' src='../Cosmetics/Makeup/{$product_image}' /></td>";
        echo "<td><a href='make_up.php?delete={$product_id}'>DELETE</a></td>";
        echo "<td><a href='make_up.php?edit={$product_id}'>EDIT</a></td>";		
		echo "</tr>";
    } 
