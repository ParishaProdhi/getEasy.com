...
include "../open_modal.php";
		...
		add_item('menz_wear','../Fashion/Menz Wear/');
	}
}
if(isset($_GET['delete'])){
	delete_product('menz_wear','menz_wear');
}
...
<div class="content">
<form action="menz_wear.php" method="POST" enctype="multipart/form-data">
...
if(isset($_GET['edit'])){
	...
	edit('menz_wear','../Fashion/Menz Wear/');
...
<div class="content">
 ...
 while($row = mysqli_fetch_assoc($select_item)){
		...
		echo "<td><image class='adminimg' src='../Fashion/Menz Wear/{$product_image}' /></td>";
        echo "<td><a href='menz_wear.php?delete={$product_id}'>DELETE</a></td>";
        echo "<td><a href='menz_wear.php?edit={$product_id}'>EDIT</a></td>";		
		echo "</tr>";
    } 
