...
include "../open_modal.php";
		...
		add_item('deshi_kitchen','../Food/Deshi Kitchen/');
	}
}
if(isset($_GET['delete'])){
	delete_product('deshi_kitchen','deshi_kitchen');
}
...
<div class="content">
<form action="deshi_kitchen.php" method="POST" enctype="multipart/form-data">
...
if(isset($_GET['edit'])){
	...
	edit('deshi_kitchen','../Food/Deshi Kitchen/');
...
<div class="content">
 ...
 <tbody> 
 <?php
  $query = "SELECT * FROM deshi_kitchen";
 ...
 while($row = mysqli_fetch_assoc($select_item)){
		...
		echo "<td><image class='adminimg' src='../Food/Deshi Kitchen/{$product_image}' /></td>";
        echo "<td><a href='deshi_kitchen.php?delete={$product_id}'>DELETE</a></td>";
        echo "<td><a href='deshi_kitchen.php?edit={$product_id}'>EDIT</a></td>";		
		echo "</tr>";
    } 
