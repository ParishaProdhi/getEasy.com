...
include "../open_modal.php";
		...
		add_item('bistro_c','../Food/Bistro C/');
	}
}
if(isset($_GET['delete'])){
	delete_product('bistro_c','admin_bistro_c');
}
...
<div class="content">
 ...
 while($row = mysqli_fetch_assoc($select_item)){
		...
		echo "<td><image class='adminimg' src='../Food/Bistro C/{$product_image}' /></td>";
