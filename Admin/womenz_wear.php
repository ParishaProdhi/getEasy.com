...
include "../open_modal.php";
		...
		add_item('womenz_wear','../Fashion/Womenz Wear/');
	}
}
if(isset($_GET['delete'])){
	delete_product('womenz_wear','womenz_wear');
}
...
<div class="content">
<form action="womenz_wear.php" method="POST" enctype="multipart/form-data">
...
if(isset($_GET['edit'])){
	...
	edit('womenz_wear','../Fashion/Womenz Wear/');
...
<div class="content">
 ...
 while($row = mysqli_fetch_assoc($select_item)){
		...
		echo "<td><image class='adminimg' src='../Fashion/Womenz Wear/{$product_image}' /></td>";
        echo "<td><a href='womenz_wear.php?delete={$product_id}'>DELETE</a></td>";
        echo "<td><a href='womenz_wear.php?edit={$product_id}'>EDIT</a></td>";		
		echo "</tr>";
    } 
