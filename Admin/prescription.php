...
include "../open_modal.php";
		...
		add_item('prescription','../Pharmacy/Prescription Medicine/');
	}
}
if(isset($_GET['delete'])){
	delete_product('prescription','prescription');
}
...
if(isset($_GET['edit'])){
	...
	edit('prescription','../Pharmacy/Prescription Medicine/');
...
<div class="content">
 ...
 while($row = mysqli_fetch_assoc($select_item)){
		...
		echo "<td><image class='adminimg' src='../Pharmacy/Prescription Medicine/{$product_image}' /></td>";
        echo "<td><a href='prescription.php?delete={$product_id}'>DELETE</a></td>";
        echo "<td><a href='prescription.php?edit={$product_id}'>EDIT</a></td>";		
		echo "</tr>";
    } 
