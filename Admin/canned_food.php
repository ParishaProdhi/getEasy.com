...
include "../open_modal.php";
		...
		add_item('canned_food','../Grocery/CANNED & PACKAGED FOODS/');
	}
}
if(isset($_GET['delete'])){
	delete_product('canned_food','canned_food');
}
...
if(isset($_GET['edit'])){
	...
	edit('canned_food','../Grocery/CANNED & PACKAGED FOODS/');
...
<div class="content">
 ...
 while($row = mysqli_fetch_assoc($select_item)){
		...
		echo "<td><image class='adminimg' src='../Grocery/CANNED & PACKAGED FOODS/{$product_image}' /></td>";
        echo "<td><a href='canned_food.php?delete={$product_id}'>DELETE</a></td>";
        echo "<td><a href='canned_food.php?edit={$product_id}'>EDIT</a></td>";		
		echo "</tr>";
    } 
