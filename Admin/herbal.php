...
include "../open_modal.php";
		...
		add_item('herbal','../Pharmacy/Herbal & Nutraceuticals');
	}
}
if(isset($_GET['delete'])){
	delete_product('herbal','herbal');
}
...
<div class="content">
<form action="herbal.php" method="POST" enctype="multipart/form-data">
...
if(isset($_GET['edit'])){
	...
	edit('herbal','../Pharmacy/Herbal & Nutraceuticals/');
...
<div class="content">
 ...
 while($row = mysqli_fetch_assoc($select_item)){
		...
		echo "<td><image class='adminimg' src='../Pharmacy/Herbal & Nutraceuticals/{$product_image}' /></td>";
        echo "<td><a href='herbal.php?delete={$product_id}'>DELETE</a></td>";
        echo "<td><a href='herbal.php?edit={$product_id}'>EDIT</a></td>";		
		echo "</tr>";
    } 
