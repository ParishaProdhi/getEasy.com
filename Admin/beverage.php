...
include "../open_modal.php";
		...
		add_item('beverage','../Grocery/Tea, Coffee & Beverages/');
	}
}
if(isset($_GET['delete'])){
	delete_product('beverage','beverage');
}
...
if(isset($_GET['edit'])){
	...
	edit('beverage','../Grocery/Tea, Coffee & Beverages/');
...
<div class="content">
 ...
 while($row = mysqli_fetch_assoc($select_item)){
		...
		echo "<td><image class='adminimg' src='../Grocery/Tea, Coffee & Beverages/{$product_image}' /></td>";
        echo "<td><a href='beverage.php?delete={$product_id}'>DELETE</a></td>";
        echo "<td><a href='beverage.php?edit={$product_id}'>EDIT</a></td>";		
		echo "</tr>";
    } 
