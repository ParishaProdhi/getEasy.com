...
include "../open_modal.php";
		...
		add_item('firefly','../Food/Fire Fly/');
	}
}
if(isset($_GET['delete'])){
	delete_product('firefly','firefly');
}
...
<div class="content">
 ...
 while($row = mysqli_fetch_assoc($select_item)){
		...
		echo "<td><image class='adminimg' src='../Food/Fire Fly/{$product_image}' /></td>";
        echo "<td><a href='firefly.php?delete={$product_id}'>DELETE</a></td>";
        echo "<td><a href='firefly.php?edit={$product_id}'>EDIT</a></td>";		
		echo "</tr>";
    } 
