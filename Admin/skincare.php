...
include "../open_modal.php";
		...
		add_item('skincare','../Pharmacy/Skin Care Products/');
	}
}
if(isset($_GET['delete'])){
	delete_product('skincare','skincare');
}
...
if(isset($_GET['edit'])){
	...
	edit('skincare','../Pharmacy/Skin Care Products/');
...
<div class="content">
 ...
 while($row = mysqli_fetch_assoc($select_item)){
		...
		echo "<td><image class='adminimg' src='../Pharmacy/Skin Care Products/{$product_image}' /></td>";
        echo "<td><a href='skincare.php?delete={$product_id}'>DELETE</a></td>";
        echo "<td><a href='skincare.php?edit={$product_id}'>EDIT</a></td>";		
		echo "</tr>";
    } 
