...
include "../open_modal.php";
		...
		add_item('nawab','../Food/Nawab/');
	}
}
if(isset($_GET['delete'])){
	delete_product('nawab','nawab');
}
...
<div class="content">
<form action="nawab.php" method="POST" enctype="multipart/form-data">
...
<div class="content">
 ...
 while($row = mysqli_fetch_assoc($select_item)){
		...
		echo "<td><image class='adminimg' src='../Food/Nawab/{$product_image}' /></td>";
        echo "<td><a href='nawab.php?delete={$product_id}'>DELETE</a></td>";
        echo "<td><a href='nawab.php?edit={$product_id}'>EDIT</a></td>";		
		echo "</tr>";
    } 
