...
include "../open_modal.php";
		...
		add_item('perfume','../Cosmetics/Perfume/');
	}
}
if(isset($_GET['delete'])){
	delete_product('perfume','perfume');
}
...
if(isset($_GET['edit'])){
	...
	edit('perfume','../Cosmetics/Perfume/');
...
<div class="content">
 ...
 while($row = mysqli_fetch_assoc($select_item)){
		...
		echo "<td><image class='adminimg' src='../Cosmetics/Perfume/{$product_image}' /></td>";
        echo "<td><a href='perfume.php?delete={$product_id}'>DELETE</a></td>";
        echo "<td><a href='perfume.php?edit={$product_id}'>EDIT</a></td>";		
		echo "</tr>";
    } 
