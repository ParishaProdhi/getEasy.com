...
include "../includes/newnav.php"; 
 ...
 include "../includes/odCart.php";
  ...
  if($product_review_id == 13)
  {$query = "SELECT * FROM make_up where product_id = {$product_id}";
  $image_src = "Makeup/";
  }
  else if($product_review_id == 14)
  {$query = "SELECT * FROM perfume where product_id = {$product_id}";
  $image_src = "Perfume/";
  }
  else if($product_review_id == 15)
  {$query = "SELECT * FROM skin_hair where product_id = {$product_id}";
  $image_src = "Skin and Hair/";
  }
