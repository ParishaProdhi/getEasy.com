...
include "../includes/newnav.php"; 
 ...
 include "../includes/odCart.php";
   ...
   if($product_review_id == 7)
  {$query = "SELECT * FROM herbal where product_id = {$product_id}";
  $image_src = "Herbal & Nutraceuticals/";
  }
  else if($product_review_id == 8)
  {$query = "SELECT * FROM prescription where product_id = {$product_id}";
  $image_src = "Prescription Medicine/";
  }
  else if($product_review_id == 9)
  {$query = "SELECT * FROM skincare where product_id = {$product_id}";
  $image_src = "Skin Care Products/";
  }
